 ...
 * @author Michael Isvy
 */
public interface PhysicianRepository extends Repository<Physician, Integer> {
	...
	Collection<Physician> findAll() throws DataAccessException;
	...
	@Transactional(readOnly = true)
	@Cacheable("physicians")
	Page<Physician> findAll(Pageable pageable) throws DataAccessException;
